...
#define Z_BUMP              2
#define A_BUMP              2
#define HOMING_X_BUMP       0.2 //this is the distance the blocker is allowed physically to go in 
#define HOMING_Y_BUMP       0.2
#define HOMING_Z_BUMP       0.2
#define HOMING_A_BUMP       0.2

#define HOMING_BUMP_MM      { 0, 0, 0 ,0}       // (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 2,2 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)

#define HOMING_BACKOFF_POST_MM { X_BUMP , Z_BUMP , Y_BUMP ,A_BUMP  }  // (linear=mm, rotational=°) Backoff from endstops after homing
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 4*60,2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
